...
namespace Traning_Platfrom_Core.Migrations
{
    ...
    [Migration("20240323051536_somechanges")]
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.EducationHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 308, DateTimeKind.Local).AddTicks(8786));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.Experience", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 308, DateTimeKind.Local).AddTicks(9618));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.JobSeeker", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 308, DateTimeKind.Local).AddTicks(7584));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.JobSeekerSkill", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 309, DateTimeKind.Local).AddTicks(435));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.Testimonial", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 310, DateTimeKind.Local).AddTicks(2378));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobApplication", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 310, DateTimeKind.Local).AddTicks(596));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobInterview", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 310, DateTimeKind.Local).AddTicks(1519));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobOpportunity", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 309, DateTimeKind.Local).AddTicks(9800));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.Organization", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 309, DateTimeKind.Local).AddTicks(2719));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.OrganizationAdmin", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 309, DateTimeKind.Local).AddTicks(3540));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Lookups.JobField", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 309, DateTimeKind.Local).AddTicks(1998));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Lookups.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 309, DateTimeKind.Local).AddTicks(1258));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 308, DateTimeKind.Local).AddTicks(6033));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 308, DateTimeKind.Local).AddTicks(5188));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.UserRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 23, 8, 15, 36, 308, DateTimeKind.Local).AddTicks(6763));
