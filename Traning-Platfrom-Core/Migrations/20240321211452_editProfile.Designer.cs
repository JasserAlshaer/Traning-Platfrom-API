...
namespace Traning_Platfrom_Core.Migrations
{
    ...
    [Migration("20240321211452_editProfile")]
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.EducationHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(1279));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.Experience", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(2226));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.JobSeeker", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 864, DateTimeKind.Local).AddTicks(9890));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.JobSeekerSkill", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(3210));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.Testimonial", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 866, DateTimeKind.Local).AddTicks(6189));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobApplication", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 866, DateTimeKind.Local).AddTicks(4148));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobInterview", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 866, DateTimeKind.Local).AddTicks(5207));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobOpportunity", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 866, DateTimeKind.Local).AddTicks(3182));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.Organization", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(5820));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.OrganizationAdmin", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(6784));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Lookups.JobField", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(4998));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Lookups.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 865, DateTimeKind.Local).AddTicks(4172));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 864, DateTimeKind.Local).AddTicks(8057));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 864, DateTimeKind.Local).AddTicks(7080));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.UserRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 22, 0, 14, 52, 864, DateTimeKind.Local).AddTicks(8892));
