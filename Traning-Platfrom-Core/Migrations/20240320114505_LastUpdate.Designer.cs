...
namespace Traning_Platfrom_Core.Migrations
{
    ...
    [Migration("20240320114505_LastUpdate")]
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.EducationHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(1513));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.Experience", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(2453));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.JobSeeker", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(593));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Client.JobSeekerSkill", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(3428));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Lookups.JobField", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(5392));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Lookups.Skill", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(4489));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobApplication", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 933, DateTimeKind.Local).AddTicks(5313));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobInterview", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 933, DateTimeKind.Local).AddTicks(6445));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.JobOpportunity", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 933, DateTimeKind.Local).AddTicks(4400));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.Organization", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(6225));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.Company.OrganizationAdmin", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 932, DateTimeKind.Local).AddTicks(7157));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 931, DateTimeKind.Local).AddTicks(8715));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 931, DateTimeKind.Local).AddTicks(7699));
            ...
            modelBuilder.Entity("Traning_Platfrom_Core.Entity.UserConfiguration.UserRoles", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 3, 20, 14, 45, 4, 931, DateTimeKind.Local).AddTicks(9576));
